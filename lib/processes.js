...
function processes(callback) {
  ...
  function parseHead(head, rights) {
    console.log('PARSE_HEAD', arguments);
    let space = (rights > 0);
    let count = 1;
    let from = 0;
    let to = 0;
    ...
    console.log('PARSE_HEAD_RESULT', result);
    return result;
  }
...
console.log('IS_LINUX', _linux);
module.exports = () => processes().then(() => undefined);
module.exports.processes = processes;
module.exports.processLoad = processLoad;
